...
<template>
  ...
  >
    <div class="flex items-center justify-between px-4 lg:px-6">
      <Label class="sr-only" for="view-selector">
        View
      </Label>
      ...
      <div class="flex items-center justify-between px-4">
        ...
        <div class="flex w-full items-center gap-8 lg:w-fit">
          <div class="hidden items-center gap-2 lg:flex">
            <Label class="text-sm font-medium" for="rows-per-page">
              Rows per page
            </Label>
            <Select
            ...
            >
              <SelectTrigger id="rows-per-page" class="w-20" size="sm">
    ...
    <TabsContent class="flex flex-col px-4 lg:px-6" value="key-personnel">
      <div class="aspect-video w-full flex-1 rounded-lg border border-dashed"></div>
    </TabsContent>
    <TabsContent
      class="flex flex-col px-4 lg:px-6"
